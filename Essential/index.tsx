          ...
          <div className="flex flex-col justify-center">
            ...
            <motion.div variants={fadeIn} className="rounded-3xl border border-black/5 bg-white p-8 shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_15px_50px_rgba(84,56,220,0.08)] transition-all duration-300 flex flex-col gap-6">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.instagram.com/ratnesh_10_/" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-full bg-[#f4f5f8] flex items-center justify-center text-[#E4405F] hover:bg-[#E4405F] hover:text-white transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
                </a>
                <a href="https://www.linkedin.com/in/ratneshkumarsingh" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-full bg-[#f4f5f8] flex items-center justify-center text-[#0A66C2] hover:bg-[#0A66C2] hover:text-white transition-colors">

          ...
          <div className="relative text-right max-w-full">
            ...
            <h2 className="font-grotesk text-[16px] sm:text-[36px] lg:text-[50px] uppercase leading-[1.1] pointer-events-auto tracking-wide">
              ...
              <div className="flex gap-4 sm:gap-6 justify-end mt-4 sm:mt-6 pointer-events-auto">
                ...
                <a href="https://www.instagram.com/ratnesh_10_/" target="_blank" rel="noreferrer" className="w-10 h-10 sm:w-14 sm:h-14 rounded-full border border-[#E4405F]/30 flex items-center justify-center text-[#E4405F] hover:bg-[#E4405F] hover:text-white transition-all hover:scale-110">
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
                </a>
                <a href="https://www.linkedin.com/in/ratneshkumarsingh" target="_blank" rel="noreferrer" className="w-10 h-10 sm:w-14 sm:h-14 rounded-full border border-[#0A66C2]/30 flex items-center justify-center text-[#0A66C2] hover:bg-[#0A66C2] hover:text-white transition-all hover:scale-110">

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="flex flex-wrap gap-6">
              ...
              <a href="https://github.com/Ratnesh919" target="_blank" rel="noopener noreferrer" className="group text-white/60 hover:text-white transition-colors">
                <div className="w-16 h-16 rounded-full bg-white/5 flex items-center justify-center border border-white/10 shrink-0 group-hover:scale-110 group-hover:bg-white/20 group-hover:text-white group-hover:border-white/50 transition-all">

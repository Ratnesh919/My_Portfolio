...
app.post('/api/chat', chatLimiter, async (req, res) => {
    try {
        ...
        if (enrichedMessages.length > 0 && enrichedMessages[0].role === 'system') {
            ...
            // Global constraints
            sysContent += '\n\n[GLOBAL CONSTRAINTS]\n1. UNIVERSAL MULTILINGUAL ABILITY: You are fluent in ALL languages of the world (English, Hindi/Hinglish, Spanish, French, German, Japanese, Chinese, Arabic, Russian, Portuguese, Italian, Korean, Bengali, Tamil, Telugu, Marathi, Punjabi, Gujarati, etc.). You MUST reply in the SAME language the user writes or speaks to you in. For all Indian regional languages (Hindi, Hinglish, Punjabi, Gujarati, Bengali, Marathi, Tamil, Telugu, etc.), ALWAYS reply in natural conversational ROMANIZED script using the English alphabet (e.g. Punjabi: "Ratnesh ne bohot vadia projects banaye ne...", Gujarati: "Ratnesh e ghana saras projects banavya che..."). If the user speaks in Spanish, French, Japanese, or other international languages, reply fluently in that language.\n2. CRITICAL EMOJI RULE: NEVER output emojis (e.g. 😊, 🚀, 👍, ✨) or markdown formatting asterisks anywhere in your speech text.\n3. CRITICAL: NEVER use the word "na" or "naa" at the end of sentences under any circumstances (e.g., do not say "hai na?", "hai na.", "karu na", "na"). Just end the sentence normally.';

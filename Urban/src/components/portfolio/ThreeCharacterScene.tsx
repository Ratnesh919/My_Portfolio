  ...
  return (
    ...
    >
      ...
      >
        ...
        <div 
          className="absolute top-4 right-1 sm:top-8 sm:right-3 z-20 transition-transform duration-200"
        ...
        <div 
          className="absolute top-1/2 -translate-y-1/2 -right-2 sm:right-1 z-20 transition-transform duration-200"
        ...
        <div 
          className="absolute bottom-4 right-1 sm:bottom-8 sm:right-3 z-20 transition-transform duration-200"

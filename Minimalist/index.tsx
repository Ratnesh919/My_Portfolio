...
import { Mail, MapPin, GraduationCap, Code2, Cpu, Wrench, Gamepad2, Layers, ExternalLink, FileText, Sparkles, ChevronRight, Facebook } from 'lucide-react';
      ...
      <main className="relative z-10 mx-auto w-full max-w-[1440px] px-6 py-8 md:px-12">
        ...
        >
          <div className="flex flex-col justify-center">
            ...
            {/* Contact Card */}
            <motion.div variants={fadeIn} className="rounded-3xl border border-black/5 bg-white p-8 shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_15px_50px_rgba(84,56,220,0.08)] transition-all duration-300">
              <div className="grid grid-cols-[auto_1fr] gap-x-6 gap-y-4">
                <Mail className="text-[#5438dc]" /> 
                <a href="mailto:kumarsinghratnesh3@gmail.com" className="text-[#1f2937] font-medium hover:text-[#5438dc] hover:underline transition-colors block">
                  kumarsinghratnesh3@gmail.com
                </a>
                <Facebook className="text-[#5438dc]" /> 
                <a href="https://www.facebook.com/share/1De11Vypsn/" target="_blank" rel="noreferrer" className="text-[#1f2937] font-medium hover:text-[#5438dc] hover:underline transition-colors block">
                  Facebook
                </a>

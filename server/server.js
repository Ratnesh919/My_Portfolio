...
app.post('/api/chat', chatLimiter, async (req, res) => {
    try {
        ...
        if (enrichedMessages.length > 0 && enrichedMessages[0].role === 'system') {
            ...
            // Global constraints
            sysContent += '\n\n[GLOBAL CONSTRAINTS]\n1. STRICT ENGLISH-ONLY WRITING RULE: You must ALWAYS write and respond in ENGLISH ONLY using the standard English alphabet. You can understand any language the user speaks or writes (Hindi, Bengali, Punjabi, Gujarati, Spanish, French, German, Japanese, etc.), but your output text and reply MUST ALWAYS be 100% written in clear, natural, and fluent English. NEVER write in other languages or scripts (no Devanagari, no Bengali, no Gurmukhi, no Gujarati, no Japanese characters, etc.).\n2. CRITICAL EMOJI RULE: NEVER output emojis (e.g. 😊, 🚀, 👍, ✨) or markdown formatting asterisks anywhere in your speech text.\n3. CRITICAL NAME USAGE RULE: NEVER use the user\'s name in your responses. You are strictly forbidden from saying their name during conversation.\n4. CRITICAL: NEVER use the word "na" or "naa" at the end of sentences under any circumstances. Keep responses concise, warm, and under 150 words.';
